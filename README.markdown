...
./bin/opensearch-plugin install https://github.com/adelean/opensearch-analysis-lemmagen/releases/download/$VERSION/opensearch-analysis-lemmagen-$VERSION-plugin.zip
```
